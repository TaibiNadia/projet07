...
resource "aws_security_group_rule" "bastion_to_web_egress_rule" {
  type                       = "egress"
  from_port                  = 22
  to_port                    = 22
  protocol                   = "tcp"
...
resource "aws_security_group_rule" "bastion_to_db_egress_rule" {
  type                       = "egress"
  from_port                  = 22
  to_port                    = 22
  protocol                   = "tcp"
...
resource "aws_security_group_rule" "web_to_db_egress_rule" {
  type                       = "egress"
  from_port                  = 3306
  to_port                    = 3306
  protocol                   = "tcp"
...
resource "aws_security_group_rule" "web_to_http_egress_rule" {
  type                       = "egress"
  from_port                  = 80
  to_port                    = 80
  protocol                   = "tcp"
...
resource "aws_security_group_rule" "web_to_bastion_egress_rule" {
  type                       = "egress"
  from_port                  = 22
  to_port                    = 22
  protocol                   = "tcp"
...
resource "aws_security_group_rule" "db_to_web_egress_rule" {
  type                       = "egress"
  from_port                  = 3306
  to_port                    = 3306
  protocol                   = "tcp"
...
resource "aws_security_group_rule" "db_to_bastion_egress_rule" {
  type                       = "egress"
  from_port                  = 22
  to_port                    = 22
  protocol                   = "tcp"
...
resource "aws_security_group_rule" "lb_to_web_egress_rule" {
  type                       = "egress"
  from_port                  = 80
  to_port                    = 80
  protocol                   = "tcp"
